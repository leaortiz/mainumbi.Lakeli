...
namespace mainumbi.Lakeli.Migrations
{
    ...
    [Migration("20220827002713_adds_base_entities")]
    partial class adds_base_entities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mainumbi.Lakeli.Customer", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("App.Customer", (string)null);
                });

            modelBuilder.Entity("mainumbi.Lakeli.Job", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("HouseAdminId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("LaborerId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("App.Job", (string)null);
                });

            modelBuilder.Entity("mainumbi.Lakeli.Laborer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("App.Laborer", (string)null);
                });

            modelBuilder.Entity("mainumbi.Lakeli.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("App.Rating", (string)null);
                });
            ...
            modelBuilder.Entity("mainumbi.Lakeli.Job", b =>
                {
                    b.HasOne("mainumbi.Lakeli.Laborer", "Laborer")
                        .WithMany()
            ...
            modelBuilder.Entity("mainumbi.Lakeli.Rating", b =>
                {
                    b.HasOne("mainumbi.Lakeli.Job", null)
                        .WithOne("Rating")
                        .HasForeignKey("mainumbi.Lakeli.Rating", "JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("mainumbi.Lakeli.Laborer", null)
                        .WithMany("Ratings")
                        .HasForeignKey("LaborerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
