...
using mainumbi.Lakeli.MultiTenancy;
using mainumbi.Lakeli.Web.Menus;
...
public class LakeliWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(LakeliResource),
                typeof(LakeliDomainModule).Assembly,
                typeof(LakeliDomainSharedModule).Assembly,
                typeof(LakeliApplicationModule).Assembly,
                typeof(LakeliApplicationContractsModule).Assembly,
                typeof(LakeliWebModule).Assembly
            );
        });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<LakeliWebModule>();
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<LakeliWebModule>(hostingEnvironment.ContentRootPath);
            });
        }
    }
    ...
    private void ConfigureNavigationServices()
    {
        ...
        {
            options.MenuContributors.Add(new LakeliMenuContributor());
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(LakeliApplicationModule).Assembly);
        });
    }
    ...
    private void ConfigureSwaggerServices(IServiceCollection services)
    {
        services.AddAbpSwaggerGen(
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "Lakeli API", Version = "v1" });
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "Lakeli API");
        });
        app.UseAuditing();
